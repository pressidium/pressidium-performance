...
If you’ve got a question, check out our 📚 [wiki](https://github.com/pressidium/pressidium-performance/wiki) and 🗃 [issues](https://github.com/pressidium/pressidium-performance/issues) before opening a new issue. If you can’t find your answer, feel free to open an issue.

We’ve got a couple of issue templates that you can use to report bugs or request new features:

* 🐞 [Report a bug](https://github.com/pressidium/pressidium-performance/issues/new?template=bug_report.md)
* 🗳️ [Request a feature](https://github.com/pressidium/pressidium-performance/issues/new?template=feature_request.md)

There’s also the 💬 [Discussions](https://github.com/pressidium/pressidium-performance/discussions/) tab where you can ask questions and discuss the project with other community members.
...
Before opening a bug report, check the 🗃 [issues](https://github.com/pressidium/pressidium-performance/issues) tab to see if the bug has already been reported. If it has, give it a thumbs up or comment with additional information. If it hasn’t, feel free to open a new issue.

When opening a bug report, please use the [bug report template](https://github.com/pressidium/pressidium-performance/issues/new?template=bug_report.md). The more information you provide, the easier it will be to reproduce and fix the bug.
...
Before requesting a new feature, check the 🗃 [issues](https://github.com/pressidium/pressidium-performance/issues) tab to see if the feature has already been requested. If it has, give it a thumbs up or comment with additional details. If it hasn’t, feel free to open a new issue.

When requesting a new feature, please use the [feature request template](https://github.com/pressidium/pressidium-performance/issues/new?template=feature_request.md). The more information you provide, the easier it will be to understand and implement the feature.
...
* ⭐ [Starring the project on GitHub](https://github.com/pressidium/pressidium-performance)
* ✍️ [Rating the plugin on the WordPress Plugin Directory](https://wordpress.org/support/plugin/pressidium-performance/reviews/#new-post)
* 🌐 [Translating the plugin](https://translate.wordpress.org/projects/wp-plugins/pressidium-performance)
* 📣 Spreading the word
